 ...
 */
final class Version20200703123600 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE quiz_utilisateur (quiz_id INT NOT NULL, utilisateur_id INT NOT NULL, INDEX IDX_323A7013853CD175 (quiz_id), INDEX IDX_323A7013FB88E14F (utilisateur_id), PRIMARY KEY(quiz_id, utilisateur_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
