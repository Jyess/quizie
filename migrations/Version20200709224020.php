 ...
 */
final class Version20200709224020 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE question (id INT AUTO_INCREMENT NOT NULL, quiz_id INT NOT NULL, intitule VARCHAR(255) NOT NULL, nb_points_bonne_reponse INT NOT NULL, nb_points_mauvaise_reponse INT NOT NULL, INDEX IDX_B6F7494E853CD175 (quiz_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE quiz (id INT AUTO_INCREMENT NOT NULL, utilisateur_createur_id INT NOT NULL, intitule VARCHAR(255) NOT NULL, plage_horaire_debut DATETIME DEFAULT NULL, plage_horaire_fin DATETIME DEFAULT NULL, cle_acces VARCHAR(5) DEFAULT NULL, INDEX IDX_A412FA9287440C76 (utilisateur_createur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reponse (id INT AUTO_INCREMENT NOT NULL, intitule VARCHAR(255) NOT NULL, vrai_faux TINYINT(1) NOT NULL, questionId INT DEFAULT NULL, INDEX IDX_5FB6DEC74B476EBA (questionId), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
